...
<!-- 
	...
	PreparedStatement 객체 : Statement를 개선 해서 만든 객체, 
	
	ResultSet객체 : DateBase에서 Select 하 값을 가져오는 객체 (Select 한 레코드셋을 담은 객체)
...
<body>
	...
	<%
		...
		try{
		Class.forName(driver);		// 해당 경로에 my-sql Driver 클래스가 존재하는지 확인
		...
		if(connect == true){
			out.println("MY-SQL server에 잘 접속 되었습니다.");	
		}else{
			out.println("MY-SQL server에 접속 실패 되었습니다.");
		}
