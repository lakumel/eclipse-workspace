...
<%@ page import = "java.sql.*,java.util.*" %>    
    ...
    <%
    	...
    	//ResultSet rs의 값을 저장하는 ArrayList 선언
...
<body>
	...
	<div>
		...
		<table width = "600px" border = "1px">
			...
			<tr><td> <%= name.get(i) %> </td> <td> <%= email.get(i) %> </td><td> <%= inputdate.get(i) %> </td>
			<td> <%= subject.get(i) %> </td><td> <%= content.get(i) %> </td>
			</tr>
