...
<body>
	...
	<%
	if (sessionId == null) { //로그인이 안되었을때 출력되는 부분
	%>
	...
	<%=sessionId%>님 로그인이 성공 되었습니다. 축하드립니다.!!
	<br>
	<br> 당신의 권한은<%=sessionRole%>입니다.
	<br>
	<br>
	...
	%>
	<p/><p/>
	<a href="getBoardList.do">게시판 리스트 갱신</a><p/>
