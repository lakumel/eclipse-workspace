...
%>
 ...
 <%
 	...
 	sql="insert into testboard(name,password,email,address,subject,content) ";
 	sql=sql+"values(?,?,?,?,?,?,?)";
	...
	pstmt.executeUpdate(sql);	//insert , update, delete 쿼리일때 사용, 톰캣 기본 설정은 commit이 작동됨
...
<jsp:forward page = "dbtb_show2.jsp" />
