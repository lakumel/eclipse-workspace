...
<%
	//DB를 접속 해서 값을 읽어옴,Select 쿼리(변숴 값이 없이 DB에서 읽어오는 쿼리)
...
<table width = "600px" border = "1px">
	<tr><td colspan="2" align = "center"><%= rs.getString("sub") %> </td> </tr>
	<tr><td>글쓴이 : <%= rs.getString("tname") %></td> <td>암호 : <%= rs.getString("tpass")%></td></tr>
	<tr><td>Email : <%= rs.getString("temail")%></td> <td>주소 : <%= rs.getString("taddr")%> </tr>
	<tr><td colspan="2" align = "center">글쓴날짜 : <%= rs.getString("today") %></td> </tr>
