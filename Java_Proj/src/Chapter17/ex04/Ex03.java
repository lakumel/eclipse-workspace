...
class MemberMethod{
	...
	public boolean removeMember(String memberID) {
		...
		return false;	//잘 삭제가 완료된 경우, 해당 id가 존재하지 않는 경우 return false
	}
	...
	public void showSize() {
		System.out.println("Set에 저장된 총 개수는 : " + memSet.size());
	}
...
public class Ex03 {
	public static void main(String[] args) {
		...
		//member 객체 5개 생성후 MemberMethod 객체의 메소드를 사용해서 set에 객체를 저장하고 삭제하고 출력하고
