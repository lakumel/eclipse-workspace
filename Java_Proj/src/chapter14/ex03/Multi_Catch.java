...
public class Multi_Catch {
	...
	public static void main(String[] args) {
		/*
		 Multi Catch : 프로그램 내에서 여러 예외를 하나의 Try Catch를 사용해서 처리 하는 방법
		 	1. 각 각 처리하는 방법
		...
		try {
			System.out.println( 3 / 0 );   //예외 : ArithmeticException //정수를 0으로 나누면 오류 발생
		...
		System.out.println( 3 / 0 ); 		//ArithmeticException
			num =Integer.parseInt("10!");	//예외 : NumberFormatException
